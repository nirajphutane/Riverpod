...
final clockProvider = StreamNotifierProvider.autoDispose<ClockProvider, UIState>(ClockProvider.new);

class ClockProvider extends AutoDisposeStreamNotifier<UIState> {

  final Clock _clock = Clock();
  StreamSubscription<UIState>? _streamSubscription;

  @override
  Stream<UIState> build() async* {
